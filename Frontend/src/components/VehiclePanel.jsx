    ...
    <div>
        ...
        <div onClick={()=>{
          ...
          <div className="w-1/2">
            ...
            <p className="font-normal text-xs text-gray-680">Affordable, compact rides</p>
          </div>
        ...
        <div onClick={()=>{
          ...
          <img className="h-10" src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_956,h_637/v1649231091/assets/2c/7fa194-c954-49b2-9c6d-a3b8601370f5/original/Uber_Moto_Orange_312x208_pixels_Mobile.png" alt="UberMoto" />
          <div className="w-1/2">
            <h4 className="font-medium text-base">
              UberMoto <span><i className="ri-user-3-fill"></i> 1</span>
            </h4>
            <h5 className="font-medium text-sm">3 mins away</h5>
            <p className="font-normal text-xs text-gray-680">Affordable motorcycle rides</p>
          </div>
